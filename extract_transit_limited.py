...
def correct_lc(start_wave, end_wave, fluxes, errors, bjds, y, t0, per, rp, a, inc,
    ...
    initial_params = np.array([rp, error_factor, 1, 0, 1./24, 0, 0])
    labels = ["rp", "error", "Fstar", "Aramp", "tau", "cy", "m"]
...
chain, lnprobs = correct_lc(args.start_wave/1000, args.end_wave/1000, binned_fluxes, binned_errors, binned_bjds, binned_y - smoothed_binned_y, float(items["t0"]), float(items["per"]),
